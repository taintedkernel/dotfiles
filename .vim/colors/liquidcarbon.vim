...
if exists("g:liquidcarbon_high_contrast") && g:liquidcarbon_high_contrast
    ...
    hi CursorLine      guifg=NONE      guibg=#4a4a4a   gui=NONE
...
hi  FoldColumn      guifg=#68838b   guibg=bg        gui=bold
hi  Folded          guifg=#68838b   guibg=bg        gui=NONE
...
hi  TabLine         guifg=#afd787   guibg=#444444   gui=NONE
hi  TabLineFill     guifg=fg        guibg=bg        gui=reverse
hi  TabLineSel      guifg=bg        guibg=#afd787   gui=bold
